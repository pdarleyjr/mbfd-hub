      ...
      <div className="mb-6">
        <div className="flex justify-between items-start mb-4">
          ...
          <button
            ...
            className="px-4 py-2 bg-green-600 text-white rounded-md hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 transition-colors flex items-center space-x-2"
          >
