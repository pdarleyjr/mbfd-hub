...
**Available in CE:** `plugin-workflow-request` — can make outbound HTTP calls from Workflow triggers. This can be used to read/write Baserow data via `http://baserow:80/api/` with `Authorization: Token ***REMOVED_SECRET***`.
