...
} catch(e) { console.warn("channel.bind messaging error (non-fatal):", e.message); }
...
} catch(e) { console.warn("clientListenChannel.bind typing error (non-fatal):", e.message); }
...
} catch(e) { console.warn("clientListenChannel.bind seen error (non-fatal):", e.message); }
...
} catch(e) { console.warn("clientListenChannel.bind contactItem error (non-fatal):", e.message); }
...
} catch(e) { console.warn("clientListenChannel.bind messageDelete error (non-fatal):", e.message); }
...
} catch(e) { console.warn("clientListenChannel.bind deleteConversation error (non-fatal):", e.message); }

// -------------------------------------
// presence channel [User Active Status]
var activeStatusChannel;
try {
  activeStatusChannel = pusher.subscribe("presence-activeStatus");
...
} catch(e) { console.warn("activeStatusChannel error (non-fatal):", e.message); }
