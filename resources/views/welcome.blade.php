...
<body class="antialiased bg-slate-50 text-slate-900 min-h-screen">
    ...
    <header class="sticky top-0 z-50 bg-slate-850 border-b border-slate-700/50 backdrop-blur-md h-16 flex items-center justify-between px-4 lg:px-6">
        ...
        <div class="hidden md:flex items-center gap-2">
            ...
            <span class="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-purple-500/15 border border-purple-500/30 text-purple-400 text-xs font-medium">
        ...
        <div class="flex items-center gap-2">
            <a href="{{ url('/login') }}" class="min-h-[44px] px-4 py-2 text-sm font-medium text-slate-300 hover:text-white hover:bg-slate-700/50 rounded-lg transition-colors">
                Admin Login
            </a>
            <a href="{{ url('/admin') }}" class="min-h-[44px] px-4 py-2 text-sm font-medium bg-red-600 text-white rounded-lg hover:bg-red-700 transition-colors flex items-center gap-2">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path></svg>
                <span class="hidden sm:inline">Open Platform</span>
            </a>
        </div>
    </header>
            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <div class="bg-white rounded-xl shadow-card border border-slate-200 p-4">
                    <h3 class="text-sm font-semibold text-slate-800 mb-4 flex items-center gap-2">
                        ...
                        <!-- Station Inventory -->
                        <a href="{{ url('/admin/station-inventory') }}" class="group block p-4 bg-white rounded-lg border border-slate-200 hover:border-amber-400 hover:shadow-card-hover transition-all duration-200">
                            <div class="flex items-start gap-3">
                                ...
                                <div class="flex-1 min-w-0">
                                    <h3 class="font-semibold text-slate-800 group-hover:text-amber-700">Station Inventory</h3>
                                    <p class="text-sm text-slate-500">Manage station equipment and supplies</p>
                                </div>
                        ...
                        <!-- Training Panel -->
                        <a href="{{ url('/training') }}" class="group block p-4 bg-white rounded-lg border border-slate-200 hover:border-blue-400 hover:shadow-card-hover transition-all duration-200">
                            <div class="flex items-start gap-3">
                                ...
                                <div class="flex-1 min-w-0">
                                    <h3 class="font-semibold text-slate-800 group-hover:text-blue-700">Training Panel</h3>
                                    <p class="text-sm text-slate-500">Training modules and certifications</p>
                                </div>
                        ...
                        <a href="{{ url('/daily') }}" class="group block p-4 bg-white rounded-lg border border-slate-200 hover:border-purple-400 hover:shadow-card-hover transition-all duration-200">
                            <div class="flex items-start gap-3">
                                ...
                                <div class="flex-1 min-w-0">
                                    <h3 class="font-semibold text-slate-800 group-hover:text-purple-700">Daily Checkout</h3>
                                    <p class="text-sm text-slate-500">Apparatus checkout and status updates</p>
                                </div>
