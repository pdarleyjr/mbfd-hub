<x-filament-panels::page>
    <div style="display: grid; grid-template-columns: 1fr; gap: 1.5rem;">
        ...
        {{-- MBFD Workgroup Summary Card --}}
        <a href="{{ $this->getWorkgroupSummaryUrl() }}"
           target="_blank"
           rel="noopener noreferrer"
           style="
               display: block;
            ...
            <div style="display: flex; align-items: flex-start; gap: 1rem;">
                ...
                <div style="flex: 1; min-width: 0;">
                    ...
                    <p style="
                        ...
                        margin: 0;
                        line-height: 1.5;
                    ">Complete equipment evaluation, procurement analysis, and final selection report — 14 products, 6 manufacturers, 4 operational categories with product images, data tables, and one-click PDF/print export. Formatted for command staff distribution.</p>
                </div>
                <div style="flex-shrink: 0; color: #a3a3a3; align-self: center;">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" style="width: 1.25rem; height: 1.25rem;">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M13.5 6H5.25A2.25 2.25 0 0 0 3 8.25v10.5A2.25 2.25 0 0 0 5.25 21h10.5A2.25 2.25 0 0 0 18 18.75V10.5m-10.5 6L21 3m0 0h-5.25M21 3v5.25" />
