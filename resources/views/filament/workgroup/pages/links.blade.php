<x-filament-panels::page>
    <div style="display: grid; grid-template-columns: 1fr; gap: 1.5rem;">
        ...
        {{-- MBFD Workgroup Final Recommendations Card --}}
        <a href="{{ $this->getFinalRecommendationsUrl() }}"
           target="_blank"
           rel="noopener noreferrer"
           style="
               display: block;
           ...
           onmouseenter="this.style.transform='translateY(-2px)'; this.style.boxShadow='0 10px 15px -3px rgba(0,0,0,0.1), 0 4px 6px -2px rgba(0,0,0,0.05)'; this.style.borderColor='rgba(212,212,212,1)';"
           onmouseleave="this.style.transform='translateY(0)'; this.style.boxShadow='0 1px 2px 0 rgba(0,0,0,0.05)'; this.style.borderColor='rgba(229,229,229,0.6)';"
           onfocus="this.style.outline='none'; this.style.boxShadow='0 0 0 2px #b45309';"
           onblur="this.style.boxShadow='0 1px 2px 0 rgba(0,0,0,0.05)';"
        >
            <div style="display: flex; align-items: flex-start; gap: 1rem;">
                <div style="
                ...
                <div style="flex: 1; min-width: 0;">
                    <div style="display: flex; align-items: center; gap: 0.5rem; margin-bottom: 0.25rem;">
                        <h3 style="
                            ...
                            line-height: 1.4;
                            font-family: 'Plus Jakarta Sans', system-ui, sans-serif;
                        ">MBFD Workgroup Final Recommendations</h3>
                        <span style="
                            display: inline-block;
                            padding: 0.125rem 0.5rem;
                            background: #b45309;
                    ...
                    <p style="
                        ...
                        margin: 0;
                        line-height: 1.5;
                    ">Final Equipment Selection &amp; Implementation Report — includes deployment strategy, train-the-trainer plan, in-service requirements, and workgroup determinations submitted to Fire Chief and Health &amp; Safety Committee.</p>
                </div>
                <div style="flex-shrink: 0; color: #a3a3a3; align-self: center;">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" style="width: 1.25rem; height: 1.25rem;">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M13.5 6H5.25A2.25 2.25 0 0 0 3 8.25v10.5A2.25 2.25 0 0 0 5.25 21h10.5A2.25 2.25 0 0 0 18 18.75V10.5m-10.5 6L21 3m0 0h-5.25M21 3v5.25" />
