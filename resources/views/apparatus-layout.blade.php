...
<head>
    ...
    <title>Apparatus Layout Planner | MBFD</title>
    ...
    <style>
        .layout-home-btn {
            ...
            color: #ffffff;
            font: 600 14px/1.2 'Plus Jakarta Sans', system-ui, -apple-system, sans-serif;
        ...
        .layout-home-btn:hover {
            background: rgba(153, 27, 27, 0.98);
        }

        .layout-home-btn:focus-visible {
            outline: 2px solid #ffffff;
            outline-offset: 2px;
        }
    </style>
    @vite(['resources/js/apparatus-layout/main.tsx'])
</head>
<body style="margin:0;padding:0;background:#0f172a;overflow:hidden;">
    <div id="apparatus-layout-root"></div>
</body>
</html>