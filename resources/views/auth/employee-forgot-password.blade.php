...
<title>Recover MBFD Identity</title><style>
...
</style></head><body><main><h1>Recover your account</h1><p>Enter your Employee ID. If an eligible account has an authoritative recovery address, private instructions will be sent. For privacy, every request receives the same response.</p>
