...
const HomeNav = () => (
  <nav className="sticky top-0 z-50 bg-slate-800 border-b border-slate-700 px-4 py-2 flex items-center gap-3">
    <a
      href="/"
      className="inline-flex items-center gap-2 px-3 py-2 text-sm font-medium text-white bg-red-600 rounded-lg hover:bg-red-700 transition-colors min-h-[40px]"
    >
    ...
    <span className="text-white font-semibold text-sm">MBFD Forms</span>
  </nav>
);
