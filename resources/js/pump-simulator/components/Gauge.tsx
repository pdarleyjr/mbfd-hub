...
const Gauge: React.FC<GaugeProps> = ({
  ...
  // Cavitation vibration keyframes
  ...
  return (
    <div style={{ width: size, height: size, position: 'relative', flexShrink: 0 }} className="gauge-container">
      <svg viewBox="0 0 200 200" width={size} height={size}>
        ...
        {/* Unit label */}
        <text x="100" y="130" textAnchor="middle" fontSize="10" fill="#555" fontWeight="700"
          fontFamily="monospace" letterSpacing="1">
          {unit}
        </text>

        {/* Label */}
        <text x="100" y="145" textAnchor="middle" fontSize="8" fill="#777" fontWeight="600"
          letterSpacing="0.5">
          {label.toUpperCase()}
        </text>
      ...
      <div style={{
        ...
        <span style={{
          ...
          color: dangerThreshold && normalizedValue >= dangerThreshold ? '#ef4444'
            : warningThreshold && normalizedValue >= warningThreshold ? '#f59e0b'
            : '#22c55e',
        }}>
