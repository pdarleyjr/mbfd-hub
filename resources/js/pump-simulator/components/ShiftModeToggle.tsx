    ...
    <div className="metal-card" style={{ padding: 16 }}>
      ...
      <div style={{ display: 'flex', gap: 8 }}>
        <motion.button
          ...
          style={{
            ...
            fontWeight: 700,
            fontSize: 13,
            color: mode === 'road' ? '#fff' : '#888',
            background: mode === 'road'
              ? 'linear-gradient(135deg, #059669, #047857)'
              : 'linear-gradient(135deg, #1e1e2e, #2a2a3a)',
        ...
        <motion.button
          ...
          style={{
            ...
            fontWeight: 700,
            fontSize: 13,
            color: mode === 'pump' ? '#fff' : '#888',
            background: mode === 'pump'
      ...
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 8, marginTop: 10 }}>
        <div style={{
          ...
          height: 8,
          borderRadius: '50%',
          background: mode === 'road' ? '#22c55e' : '#f59e0b',
          boxShadow: `0 0 8px ${mode === 'road' ? '#22c55e' : '#f59e0b'}`,
        }} />
        <span style={{ fontSize: 11, color: '#888' }}>
          {mode === 'road' ? 'Power to wheels' : 'Pump engaged — water flowing'}
        </span>
      </div>
    </div>
  );
