...
class GmailService
{
     ...
     * @param string|null $cc Optional CC addresses
     * @param string|null $bcc Optional BCC addresses
    ...
    public function sendEmail(
        ...
        if (!$this->clientId || !$this->clientSecret || !$this->refreshToken) {
            return [
                'success' => false,
                'message_id' => null,
                'error' => 'Gmail OAuth credentials not configured. Set GOOGLE_CLIENT_ID, GOOGLE_CLIENT_SECRET, GOOGLE_REFRESH_TOKEN in .env',
            ];
        }
