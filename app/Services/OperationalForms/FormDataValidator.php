...
final class FormDataValidator
{
    ...
    private function validateFroc(array $data, bool $forCompletion): array
    {
        ...
        $rules = [
            ...
            'labor.*.category' => ['nullable', 'string', 'max:10'],
            ...
            'equipment_hours.*.category' => ['nullable', 'string', 'max:10'],
            ...
            'vehicle_mileage.*.category' => ['nullable', 'string', 'max:10'],
            ...
            'materials.*.category' => ['nullable', 'string', 'max:10'],
