 ...
 * keeps the display API request path free of any LLM latency and only invokes
 * the configured logical capability when there is new information to describe.
 *
...
JSON;
    ...
    private function logicalCapability(): string
    {
        return trim((string) config('cloudflare.ai.gateway.capability')) ?: 'mbfd-general';
    }
}
