...
class WorkgroupSurveyAnswer extends Model
{
    ...
    {
        return ['answer' => 'array', 'question_snapshot' => 'array'];
    }
    ...
    {
        return $this->belongsTo(WorkgroupSurveyResponse::class, 'survey_response_id');
    }

    /** @return BelongsTo<WorkgroupSurveyQuestion, $this> */
    public function question(): BelongsTo
    {
        return $this->belongsTo(WorkgroupSurveyQuestion::class, 'survey_question_id');
    }
}
