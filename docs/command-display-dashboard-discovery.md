...
| ScreenTinker sync | Mirror admin passwords to media | `config/services.php` (`screentinker`) | Stub (no observer found) | Do not trigger | Implementation missing | None (internal) |
