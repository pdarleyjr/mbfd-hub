...
## 16. Full February 2026 Session Summary (2026-02-18)
...
## 17. Apparatus CSV Update Detail (2026-02-18)

### Source Document
**File**: `Apparatus Status report 2/13/2026`  
**Provided by**: Gerald De Young (Fire Fleet Supervisor) / Alian Gonzalez (Fleet Manager)  
**Total apparatus rows**: 25  
**Stations covered**: 1, 2, 3, 4 (plus Reserve pool)

### CSV Columns → Database Mapping

| CSV Column | DB Column | Notes |
|------------|-----------|-------|
| Vehicle No | `vehicle_number` | Match key |
| Designation | `designation` | Callsign (E1, L1, R2…) |
| Assignment | `assignment` | Station or "Reserve" |
| Current Location | `current_location` | Physical location |
| Status | `status` | Available / In Service / Out of service |
| Notes | `notes` | Fleet notes |
| Class Description | `class_description` | ENGINE / RESCUE / LADDER / AIR TRUCK |

### Database Backup
```
Location: /root/backup_apparatuses_20260218.sql (on VPS)
Size:      155 lines
Timestamp: 2026-02-18 17:39 UTC
```

### Updates Applied (10 records)

| ID | Name | Field Changed | Old Value | New Value |
|----|------|---------------|-----------|-----------|
| 39 | LADDER L1 (002-12) | status | Out of Service | In Service |
| 39 | LADDER L1 (002-12) | current_location | Fire Fleet | Station 1 |
| 39 | LADDER L1 (002-12) | notes | "Back from expert…needs one more repair" | (cleared) |
| 45 | RESCUE R2 (16507) | status | In Service | Out of Service |
| 45 | RESCUE R2 (16507) | notes | (empty) | "Repairs to sub floor" |
| 51 | RESCUE R4 (17502) | notes | "In service Sunday" | (cleared) |
| 53 | ENGINE E11 (002-14) | status | Out of Service | Available |
| 53 | ENGINE E11 (002-14) | notes | "Out of service for Fuel leak" | (cleared) |
| 54 | ENGINE E21 (002-16) | current_location | Fire Fleet | Station 2 |
| 56 | LADDER L11 (002-6) | status | In Service | Available |
| 56 | LADDER L11 (002-6) | current_location | Station 1 | Station 2 |
| 56 | LADDER L11 (002-6) | notes | "In service as L1 now" | (cleared) |
| 57 | RESCUE 1033 | status | Out of Service | Available |
| 57 | RESCUE 1033 | notes | "Radiator failed after overheat" | (cleared) |
| 58 | RESCUE 1034 | status | In Service | Available |
| 58 | RESCUE 1034 | notes | "In service Sunday for event" | (cleared) |
| 60 | RESCUE 1036 | status | In Service | Available |
| 60 | RESCUE 1036 | notes | "In service Sunday for event" | (cleared) |
| 62 | RESCUE 14501 | current_location | Station 4 | Station 2 |
| 62 | RESCUE 14501 | notes | "In service as rescue 4" | "In Service as R2" |

### No-Action Records

- **15 apparatus** already matched CSV exactly — no changes needed
- **ID 63 (Captain 5)** — Not in fleet CSV; preserved unchanged (no vehicle number, administrative record)

### Post-Update Verification

| Endpoint | HTTP Status | Result |
|----------|-------------|--------|
| `https://support.darleyplex.com/admin` | 302 | ✅ Redirects to login (normal) |
| `https://support.darleyplex.com/admin/stations` | 302 | ✅ Redirects to login (normal) |
| `https://support.darleyplex.com/daily` | 200 | ✅ React Daily Checkout SPA loads |

**No integration breakage detected. All systems operational.**

---

**Document Status**: Updated  
**Last Updated**: 2026-02-18  
**Last Apparatus CSV Import**: 2026-02-18 (source file: 2/13/2026 fleet report)  
**Maintained By**: Development Team
